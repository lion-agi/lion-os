...
from lion.core.typing import UNDEFINED, Field, Note
...
def test_component_field_updates_timestamp():
    ...
    initial_timestamp = component.metadata.get("last_updated", {}).get("test_field")
    ...
    new_timestamp = component.metadata.get("last_updated", {}).get("test_field")
