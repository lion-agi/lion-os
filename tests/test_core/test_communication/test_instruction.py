...
from lion.core.communication import Instruction
...
def test_instruction_with_context():
    ...
    context = {"key": "value"}
    instruction = Instruction(
        instruction="Test", context=context, sender="user", recipient="assistant"
    )
...
def test_instruction_with_guidance():
    ...
    instruction = Instruction(
        instruction="Test", guidance=guidance, sender="user", recipient="assistant"
    )
...
def test_instruction_with_request_fields():
    ...
    instruction = Instruction(
        instruction="Test", request_fields=fields, sender="user", recipient="assistant"
    )
...
def test_instruction_with_plain_content():
    ...
    instruction = Instruction(
        instruction="Test", plain_content=content, sender="user", recipient="assistant"
    )
...
def test_instruction_with_tool_schemas():
    ...
    instruction = Instruction(
        instruction="Test", tool_schemas=schemas, sender="user", recipient="assistant"
    )
