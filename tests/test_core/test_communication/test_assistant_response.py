...
def test_assistant_response_with_streaming():
    ...
    response = AssistantResponse(
        assistant_response=stream_responses, sender="assistant", recipient="user"
    )
...
def test_prepare_assistant_response():
    ...
    from lion.core.communication.assistant_response import prepare_assistant_response
...
def test_assistant_response_clone():
    ...
    original = AssistantResponse(
        assistant_response="Test response", sender="assistant", recipient="user"
    )
