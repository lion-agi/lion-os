...
from lion.core.communication import ActionRequest, ActionResponse
...
def test_prepare_action_response_content():
    ...
    from lion.core.communication.action_response import prepare_action_response_content
...
def test_action_response_str_representation():
    ...
    action_request = ActionRequest(
        function="test_function", arguments={}, sender="user", recipient="assistant"
    )
